...
if __name__ == '__main__':
	...
	for i in range(len(process_stack)):
		...
		slide_id1 = str(process_stack.loc[i, 'slide_id1'])
		...
		if isinstance(data_args.data_dir, str):
			...
			raise NotImplementedError
		mask_file = os.path.join(r_slide_save_dir, slide_id1+'_mask.pkl')
		...
		block_map_save_path = os.path.join(r_slide_save_dir, '{}_blockmap.h5'.format(slide_id1))
		mask_path = os.path.join(r_slide_save_dir, '{}_mask.jpg'.format(slide_id1))
		...
		features_path = os.path.join(r_slide_save_dir, slide_id1+'.pt')
		h5_path = os.path.join(r_slide_save_dir, slide_id1+'.h5')
		...
		if os.path.isfile(os.path.join(r_slide_save_dir, heatmap_save_name)):
			...
			heatmap.save(os.path.join(r_slide_save_dir, '{}_blockmap.png'.format(slide_id1)))
			del heatmap

		save_path = os.path.join(r_slide_save_dir, '{}_{}_roi_{}.h5'.format(slide_id1, patch_args.overlap, heatmap_args.use_roi))
		...
		if not os.path.isfile(save_path):
			...
			if heatmap_args.use_roi:
				save_path_full = os.path.join(r_slide_save_dir, '{}_{}_roi_False.h5'.format(slide_id1, patch_args.overlap))
		...
		heatmap_save_name = '{}_{}_roi_{}_blur_{}_rs_{}_bc_{}_a_{}_l_{}_bi_{}_{}.{}'.format(slide_id1, float(patch_args.overlap), int(heatmap_args.use_roi),
